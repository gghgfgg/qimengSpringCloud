...
public class StudentInform {
    ...
    public void setOverseasChinese(String overseasChinese) {
        this.overseasChinese = overseasChinese == null ? null : overseasChinese.trim();
    }
    ...
    public void setCensusRegisterType(String censusRegisterType) {
        this.censusRegisterType = censusRegisterType == null ? null : censusRegisterType.trim();
    }
    ...
    public void setStudyingWay(String studyingWay) {
        this.studyingWay = studyingWay == null ? null : studyingWay.trim();
    }
    ...
    public void setWorkersChildren(String workersChildren) {
        this.workersChildren = workersChildren == null ? null : workersChildren.trim();
    }
    ...
    public void setPreschoolEducation(String preschoolEducation) {
        this.preschoolEducation = preschoolEducation == null ? null : preschoolEducation.trim();
    }
    ...
    public void setLeftoverChildren(String leftoverChildren) {
        this.leftoverChildren = leftoverChildren == null ? null : leftoverChildren.trim();
    }
    ...
    public void setMartyrChildren(String martyrChildren) {
        this.martyrChildren = martyrChildren == null ? null : martyrChildren.trim();
    }
    ...
    public void setBoarderAlimony(String boarderAlimony) {
        this.boarderAlimony = boarderAlimony == null ? null : boarderAlimony.trim();
    }
    ...
    public void setAuxiliaryNumber(String auxiliaryNumber) {
        this.auxiliaryNumber = auxiliaryNumber == null ? null : auxiliaryNumber.trim();
    }
    ...
    public void setLearningClass(String learningClass) {
        this.learningClass = learningClass == null ? null : learningClass.trim();
    }
    ...
    public void setDisabilityTypes(String disabilityTypes) {
        this.disabilityTypes = disabilityTypes == null ? null : disabilityTypes.trim();
    }
    ...
    public void setFamilyWork(String familyWork) {
        this.familyWork = familyWork == null ? null : familyWork.trim();
    }
    ...
    public void setFamilyResidence(String familyResidence) {
        this.familyResidence = familyResidence == null ? null : familyResidence.trim();
    }
    ...
    public void setFamilyCensusRegister(String familyCensusRegister) {
        this.familyCensusRegister = familyCensusRegister == null ? null : familyCensusRegister.trim();
    }
