...
public class ExcelImpotUtils {
		...
		try {
			...
			for (int i = 0; i < firstRow.getLastCellNum(); i++) {
				...
				if (currentCell == null || currentCell.getCellType() == CellType.BLANK
						|| StringUtils.isEmpty((currentCell + "").trim())) {
					continue;
				}
	...
	public static <T> List<T> excelToList(InputStream in, Class<T> entityClass, List<FieldDefine> fieldMap,
	 ...
	 */
	private static void setFieldValueByName(String fieldName, Object fieldValue, Object entity) throws Exception {
	...
	public static <T> void listToExcel(List<T> list, List<FieldDefine> fieldMap, String sheetName, int sheetSize,
	 ...
	 */
	public static <T> void listToExcel(List<T> list, List<FieldDefine> fieldMap, String sheetName, OutputStream out)
			throws ExcelException {
	 ...
	 * @throws ExcelException
	 */
	public static <T> void listToExcel(List<T> list, List<FieldDefine> fieldMap, String sheetName,
			HttpServletResponse response) throws ExcelException {
	 ...
	 */
	private static <T> void fillSheet(Sheet sheet, List<T> list, List<FieldDefine> fieldMap, int firstIndex,
