...
//        BASE64Decoder base64Decoder = new BASE64Decoder();
    ...
    public String decodeWechat(String deskey, String desIV,String data) throws Exception {
    	
    	Key sKeySpec=new SecretKeySpec(Base64.getDecoder().decode(deskey), "AES");
    	AlgorithmParameters params = AlgorithmParameters.getInstance("AES");
    	AlgorithmParameterSpec ivSpec = new IvParameterSpec(Base64.getDecoder().decode(desIV));// 设置向量
    	params.init(ivSpec);
        Cipher deCipher = Cipher.getInstance("AES/CBC/PKCS5Padding");
        deCipher.init(Cipher.DECRYPT_MODE, sKeySpec, params);
//        BASE64Decoder base64Decoder = new BASE64Decoder();
        byte[] pasByte = deCipher.doFinal(Base64.getDecoder().decode(data));
        return new String(pasByte, "UTF-8");
    }
