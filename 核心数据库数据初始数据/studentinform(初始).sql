...
-- ----------------------------
INSERT INTO `auxiliary_recycle_type` VALUES ('1', '1', '瓶子', '个', '1', '2019-09-05 14:27:18', '2019-09-05 14:34:42');
INSERT INTO `auxiliary_recycle_type` VALUES ('2', '2', '纸', '克', '70', '2019-09-05 14:27:55', '2019-09-05 14:29:23');
...
-- ----------------------------
INSERT INTO `auxiliary_school_contacts_type` VALUES ('1', '0', '门卫', '0', '2019-09-05 14:37:02', '2019-09-05 14:37:02');
INSERT INTO `auxiliary_school_contacts_type` VALUES ('2', '1', '负责老师', '0', '2019-09-05 14:38:36', '2019-09-05 14:38:36');
...
CREATE TABLE `global_data` (
  ...
  `update_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `global_key` (`global_key`) USING HASH
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of global_data
-- ----------------------------
INSERT INTO `global_data` VALUES ('1', 'qrUrl', 'http://o0c.cn/', '2019-09-05 17:27:34', '2019-09-05 17:30:16');
INSERT INTO `global_data` VALUES ('2', 'startTime', '2018-11-22 09:00:00', '2019-09-10 15:51:44', '2019-09-10 15:52:54');
...
CREATE TABLE `kernel_student_data` (
  ...
  `activity_count` int(11) unsigned NOT NULL DEFAULT '0',
...
INSERT INTO `machine_device_management` VALUES ('7', '2144003477', 'cad5f302f2638a43ad839081611e3c68', '2144003477', '440511', '1', '2019-09-07 16:43:06', '2019-09-07 17:07:01');
INSERT INTO `machine_device_management` VALUES ('8', '2144003406', '4932ba462ac7173ea231da0d8fe1e10a', '2144003406', '440507', '1', '2019-09-07 16:43:14', '2019-09-07 17:07:12');
INSERT INTO `machine_device_management` VALUES ('9', '214400347501', '196e93a3ffa5c52118b0985f1db12b24', '214400347501', '440511', '1', '2019-09-07 16:43:23', '2019-09-07 17:07:21');

-- ----------------------------
-- Table structure for machine_device_opencode_log
-- ----------------------------
DROP TABLE IF EXISTS `machine_device_opencode_log`;
CREATE TABLE `machine_device_opencode_log` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uuid` char(32) DEFAULT NULL,
  `create_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- ----------------------------
-- Records of machine_device_opencode_log
-- ----------------------------
...
-- ----------------------------
-- Table structure for machine_device_recycle_order
-- ----------------------------
DROP TABLE IF EXISTS `machine_device_recycle_order`;
CREATE TABLE `machine_device_recycle_order` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `machine_id` char(14) DEFAULT NULL,
  `uuid` char(32) DEFAULT NULL,
  `order_type` tinyint(1) unsigned DEFAULT NULL,
  `recycle_type` tinyint(1) unsigned DEFAULT NULL,
  `sys_count` int(11) unsigned DEFAULT NULL,
  `create_time` datetime DEFAULT NULL,
  `real_count` int(11) unsigned DEFAULT NULL,
  `upload_time` datetime DEFAULT NULL,
  `b_end` tinyint(1) unsigned zerofill NOT NULL,
...
-- ----------------------------
-- Records of machine_device_recycle_order
-- ----------------------------

-- ----------------------------
-- Table structure for machine_device_recycle_real_time
-- ----------------------------
DROP TABLE IF EXISTS `machine_device_recycle_real_time`;
CREATE TABLE `machine_device_recycle_real_time` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `machine_id` char(14) DEFAULT NULL,
  `type` tinyint(1) unsigned DEFAULT NULL,
  `count` int(11) unsigned zerofill NOT NULL,
  `b_recycle` tinyint(1) unsigned zerofill NOT NULL,
  `create_time` datetime DEFAULT NULL,
  `end_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
-- Records of machine_device_recycle_real_time
-- ----------------------------
...
-- ----------------------------
INSERT INTO `machine_device_state_log` VALUES ('1', '083c8de7134a1765a72efb4cc9cc71d0', '1', '0', '正常', '2019-09-07 17:16:13');
INSERT INTO `machine_device_state_log` VALUES ('2', '372d42dd2c70958e4ff5b9ac8e9703c8', '1', '0', '正常', '2019-09-07 17:16:43');
INSERT INTO `machine_device_state_log` VALUES ('3', 'a85cc5a4fb370f1dea8957f54e37b71a', '1', '0', '正常', '2019-09-07 17:16:48');
INSERT INTO `machine_device_state_log` VALUES ('4', 'b7cdfd90fadf584ccc65e4e9105c259a', '1', '0', '正常', '2019-09-07 17:16:52');
INSERT INTO `machine_device_state_log` VALUES ('5', '61728977dcf73f7e6d331a782ee3e194', '1', '0', '正常', '2019-09-07 17:16:58');
INSERT INTO `machine_device_state_log` VALUES ('6', '3b4485f7a412a3874d9162dcc99899a4', '1', '0', '正常', '2019-09-07 17:17:04');
INSERT INTO `machine_device_state_log` VALUES ('7', 'cad5f302f2638a43ad839081611e3c68', '1', '0', '正常', '2019-09-07 17:17:12');
INSERT INTO `machine_device_state_log` VALUES ('8', '4932ba462ac7173ea231da0d8fe1e10a', '1', '0', '正常', '2019-09-07 17:17:18');
INSERT INTO `machine_device_state_log` VALUES ('9', '196e93a3ffa5c52118b0985f1db12b24', '1', '0', '正常', '2019-09-07 17:17:23');
...
-- ----------------------------
INSERT INTO `management_application_management` VALUES ('1', '7166912116544633', '293dJFsmjfIJgfoa', 'asfsa248', '7', '内部测试权限', '1', '2019-09-04 20:10:46', '2019-09-04 20:10:46');
INSERT INTO `management_application_management` VALUES ('2', '7166912116544627', '9ba45bfd50064232', 'yToM65Iu', '1', '回收机', '1', '2019-09-04 21:18:25', '2019-09-04 21:18:25');
INSERT INTO `management_application_management` VALUES ('3', '7564564864648644', '9bacasuhnfahfoia', 'sdoapifu', '2', '大屏机商城', '1', '2019-09-04 21:26:03', '2019-09-04 21:26:03');
INSERT INTO `management_application_management` VALUES ('4', '7845345646154645', '384FJcvcjaSDAACS', '13ASAhda', '2', '微信商城', '1', '2019-09-04 21:28:03', '2019-09-04 21:28:03');
INSERT INTO `management_application_management` VALUES ('5', '7166912116544626', 'fjaAGEGpjaPJ13as', 'agjuFWyf', '0', '小程序', '1', '2019-09-04 21:31:14', '2019-09-04 21:34:52');
